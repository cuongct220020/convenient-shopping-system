...
with open('/home/gpus/hachi/convenient-shopping-system/crawler/data/recipes_detail.json', 'r', encoding='utf-8') as f:
    recipes = json.load(f)
...
# Save output
with open('/home/gpus/hachi/convenient-shopping-system/crawler/data/recipe_v1.json', 'w', encoding='utf-8') as f:
