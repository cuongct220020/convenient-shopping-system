...
@ws_bp.websocket("/notifications/general")
async def ws_general_notifications(request, ws: WebSocket):
    """WebSocket cho thông báo chung - tất cả người dùng có thể kết nối"""
