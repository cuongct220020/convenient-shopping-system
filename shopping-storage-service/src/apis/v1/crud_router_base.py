...
def create_crud_router(
    ...
    def create_item(current_user: CurrentUser, obj_in: create_schema = Body(...), db: Session = Depends(get_db)):      # type: ignore
        # Verify user has permission to create the resource
