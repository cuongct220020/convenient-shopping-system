          ...
          <div className="px-6 pt-4 pb-8">
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-gray-700 text-sm leading-relaxed text-justify mb-4">
                Xin chào <span className="font-bold text-[#c93045]">username</span>,
                bạn đã đăng nhập thành công. Bạn cần xác nhận tài khoản để tiếp tục
                sử dụng ứng dụng. Vui lòng nhập mã 6 chữ số được gửi đến email của bạn.
              </p>
