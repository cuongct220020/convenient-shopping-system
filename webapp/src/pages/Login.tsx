        ...
        <div className="flex-1 overflow-y-auto no-scrollbar relative z-10">
          <div className="px-6 pb-8 pt-2">
            ...
            <div className="text-center mb-8">
              ...
              {/* Đăng nhập Text */}
              <h2 className="text-3xl font-bold text-[#c93045]">
                Đăng nhập
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-right mb-4">
                <Link to="/forgot-password-1" className="text-[#c93045] font-bold text-xs hover:underline">
                  Quên mật khẩu?
                </Link>
              </div>
            ...
            {/* Register Button */}
            <div>
              <Button variant="secondary" icon={UserPlus} size="fit" onClick={() => navigate('/register')}>
                Đăng ký tài khoản
              </Button>
            </div>
